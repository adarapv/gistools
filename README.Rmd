...
of the Corine land cover dataset for the Province of Caceres. 
...
The function `buffercreate()` `betabas()` calculates buffers for sites, matrix corine dataset (reference), landscape metrics fragstats (McGarigal & Marks, 1995). 
