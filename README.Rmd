...
An R package for analysing spatial ecological data. This package is meant to provide a collection of self-written functions for the analyses of biodiversity data in relation to landscape characteristics (including GBI, green and blue infrastructures).
...
of the Corine Land Cover dataset (reference). 
...
The function `buffercreate()` create buffers of given size around a set of sites. 
and calculates a bunch of landscape metrics as implemented in fragstats (McGarigal & Marks, 1995). 

Example using the Corine Land Cover data (reference) for the province of Caceres (Spain):
